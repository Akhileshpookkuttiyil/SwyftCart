    ...
    <div className="px-6 md:px-16 lg:px-32 pt-14 space-y-10 animate-pulse">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16">
            <div className="px-5 lg:px-16 xl:px-20">
                <div className="rounded-lg bg-gray-200 w-full aspect-video mb-4"></div>
            ...
            <div className="flex flex-col gap-4">
                ...
                <div className="space-y-4">
                    {[...Array(3)].map((_, i) => (
                        <div key={i} className="h-6 bg-gray-200 rounded w-1/2"></div>
                    ))}
                </div>
...
export const CartSkeleton = () => (
    <div className="flex flex-col md:flex-row gap-10 px-6 md:px-16 lg:px-32 pt-14 mb-20 animate-pulse">
        <div className="flex-1">
            <div className="h-10 bg-gray-200 rounded w-48 mb-8"></div>
            <div className="space-y-6">
                {[...Array(3)].map((_, i) => (
                    <div key={i} className="flex gap-6 items-center border-b pb-6">
        ...
        <div className="w-full md:w-96 h-[400px] bg-gray-100 rounded-xl"></div>
    </div>
);
