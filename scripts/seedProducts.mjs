...
// Use a default seller ID if needed for frontend logic that filters by user
const DEFAULT_USER_ID = "user_2sZFHS1UIIysJyDVzCpQhUhTIhw";
...
async function seedProducts() {
  try {
    ...
    const TARGET_USER_ID = "user_32seiFFk5m28Cn1oPVM0BvrEaPq";

    console.log('Deleting all existing products...');
    await Product.deleteMany({});
    console.log('Deleted.');

    console.log(`Seeding products for user: ${TARGET_USER_ID}...`);
